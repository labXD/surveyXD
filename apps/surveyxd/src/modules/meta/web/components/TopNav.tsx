...
export const TopNavComingSoon: FC = () => {
  ...
  return (
    <nav>
      <div className="p-4 flex flex-col space-y-4 md:flex-row justify-center md:justify-between items-center lg:max-w-7xl lg:mx-auto min-h-[64px]">
        <Link href={"/"}>
        ...
        >
          ...
          <span>
            {session?.user ? "Log out" : "Sign up with Google for Early Access"}
          </span>
        </button>
      </div>
    </nav>
